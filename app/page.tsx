...
const CITIES = [
  { name: 'Delhi', slug: 'delhi', lat: 28.7041, lng: 77.1025, aqi: 710, dominant: 'PM2.5', level: 'Hazardous' },
  { name: 'Mumbai', slug: 'mumbai', lat: 19.0760, lng: 72.8777, aqi: 161, dominant: 'PM2.5', level: 'Unhealthy' },
  { name: 'Bengaluru', slug: 'bangalore', lat: 12.9716, lng: 77.5946, aqi: 147, dominant: 'PM2.5', level: 'Unhealthy for Sensitive' },
  { name: 'Hyderabad', slug: 'hyderabad', lat: 17.3850, lng: 78.4867, aqi: 407, dominant: 'PM2.5', level: 'Hazardous' },
  { name: 'Chennai', slug: 'chennai', lat: 13.0827, lng: 80.2707, aqi: 114, dominant: 'PM2.5', level: 'Moderate' },
  { name: 'Kolkata', slug: 'kolkata', lat: 22.5726, lng: 88.3639, aqi: 246, dominant: 'PM2.5', level: 'Very Unhealthy' },
  { name: 'Ahmedabad', slug: 'ahmedabad', lat: 23.0225, lng: 72.5714, aqi: 117, dominant: 'PM2.5', level: 'Moderate' },
  { name: 'Pune', slug: 'pune', lat: 18.5204, lng: 73.8567, aqi: 200, dominant: 'PM2.5', level: 'Unhealthy' },
  { name: 'Jaipur', slug: 'jaipur', lat: 26.9124, lng: 75.7873, aqi: 180, dominant: 'PM2.5', level: 'Unhealthy for Sensitive' },
  { name: 'Lucknow', slug: 'lucknow', lat: 26.8467, lng: 80.9462, aqi: 513, dominant: 'PM2.5', level: 'Hazardous' },
];
      ...
      <section className="max-w-7xl mx-auto px-6 py-16">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-8">
          {cityData.map((city) => {
            ...
            return (
              <div key={city.name} className="group bg-white/95 backdrop-blur-md rounded-3xl shadow-2xl overflow-hidden hover:shadow-3xl hover:-translate-y-4 transition-all duration-500" style={{ backgroundColor: 'white' }}>
                <div className={`${color} h-48 flex flex-col items-center justify-center text-white relative overflow-hidden`}>
