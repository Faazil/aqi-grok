...
const CITIES = [
  { name: 'Delhi', slug: 'delhi', aqi: 568, dominant: 'PM2.5', level: 'Hazardous' },
  { name: 'Mumbai', slug: 'mumbai', aqi: 164, dominant: 'PM2.5', level: 'Unhealthy' },
  { name: 'Bengaluru', slug: 'bangalore', aqi: 106, dominant: 'PM2.5', level: 'Poor' },
  { name: 'Hyderabad', slug: 'hyderabad', aqi: 130, dominant: 'PM2.5', level: 'Moderate' },
  { name: 'Chennai', slug: 'chennai', aqi: 114, dominant: 'PM2.5', level: 'Moderate' },
  { name: 'Kolkata', slug: 'kolkata', aqi: 200, dominant: 'PM2.5', level: 'Unhealthy' },
  { name: 'Ahmedabad', slug: 'ahmedabad', aqi: 117, dominant: 'PM2.5', level: 'Moderate' },
  { name: 'Pune', slug: 'pune', aqi: 200, dominant: 'PM2.5', level: 'Unhealthy' },
